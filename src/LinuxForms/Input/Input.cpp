...
void Input::Initialize()
{
        ...
        keyStates[KeyCode::Clear] = KeyState();
        ...
        keyStates[KeyCode::KeypadPeriod] = KeyState();
        keyStates[KeyCode::KeypadDivide] = KeyState();
        keyStates[KeyCode::KeypadMultiply] = KeyState();
        keyStates[KeyCode::KeypadMinus] = KeyState();
        keyStates[KeyCode::KeypadPlus] = KeyState();
        keyStates[KeyCode::KeypadEnter] = KeyState();
        keyStates[KeyCode::KeypadEquals] = KeyState();
