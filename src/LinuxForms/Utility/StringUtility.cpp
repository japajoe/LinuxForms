...
std::string LinuxForms::StringUtility::Replace(std::string& haystack, const std::string& needle, const std::string& replacement)
{
    size_t start_pos = 0;
...
std::string LinuxForms::StringUtility::ToUpperCase(const std::string& text)
{
    std::string new_string{ text };
    std::transform(new_string.begin(), new_string.end(), new_string.begin(), [](unsigned char character) {
